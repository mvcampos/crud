...
if ($id != 0) {
    $query = $db->query("SELECT * FROM cidades WHERE id = " . $id);
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo href('cidades/cidades') ?>">Cidades</a></li>
            <li class="active">Cadastro de Cidades</li>
        </ol>
    </section>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cidade" id="cidade" value="<?php echo isset($row['cidade']) ? $row['cidade'] : ''; ?>" required=""/>
                            </div>
                        </div>
    ...
    <script>
        ...
        $('#formulario').submit(function (e) {
            e.preventDefault();
            $(this).ajaxSubmit({
                url: '<?php echo href('cidades/cidades-controller/cidades-cadastro') ?>',
                type: 'POST',
                dataType: 'json',
